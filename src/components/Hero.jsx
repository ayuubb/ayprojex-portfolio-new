  ...
  return (
    <section id="home" className="mx-auto grid w-[92%] max-w-6xl gap-8 py-20 md:grid-cols-[1.2fr_1fr]">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <p className="mb-3 font-mono text-sm text-emerald-300">{profile.education}</p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a
            href="#experience"
            className="inline-flex items-center gap-2 rounded-xl border border-cyan-400/40 bg-cyan-400/10 px-4 py-2 text-cyan-300 transition hover:bg-cyan-400/20"
          >
            View Experience <ArrowRight size={16} />
          </a>
          <a href="#contact" className="rounded-xl border border-emerald-400/40 px-4 py-2 text-emerald-300 hover:bg-emerald-400/10">
            Let&apos;s Collaborate
          </a>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="glass rounded-2xl border border-slate-700/60 p-6 shadow-glowEmerald"
      >
